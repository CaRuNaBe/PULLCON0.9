...
//!
void ScriptEngine::Update(ApplicationBase& game)
{
...
/**
 *¥fn void script_engine::DrawImage.
...
/**
 *¥fn void script_engine::DrawMessage.
...
/**
 *¥fn void script_engine::DrawMessageWindow.
 *¥brief メッセージウィンドウの描画
 *¥return void
 */
...
/**
 *¥fn void script_engine::DrawAnime.
 *¥brief "ve" コマンドによる描画
 *¥return void
 */
